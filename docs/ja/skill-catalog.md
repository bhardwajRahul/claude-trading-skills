...
| **[COT Contrarian Detector]({{ '/ja/skills/cot-contrarian-detector/' | relative_url }})** | CFTC先物市場の大口投機家ポジション偏りをCOT Indexで検出し、Shapiro式コントラリアン手法の第1段階を支援 | <span class="badge badge-api">FMP必須</span> |
| **[Crypto Regime Analyzer]({{ '/ja/skills/crypto-regime-analyzer/' | relative_url }})** | 無料・キー不要の公開データとオフラインスナップショットから6要素の0-100複合スコアで暗号資産市場のレジームを定量化 | <span class="badge badge-free">APIキー不要</span> |
